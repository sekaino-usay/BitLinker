...
<head>
    <meta charset="utf-8">
    <title>BitLinker - 登録不要・純国産のカスタム短縮URL作成サービス｜Delete</title>
    ...
    <div class="flex">
        <div class="flex_txt">
            ...
            <form action="./deleted" method="post">
                <input type="text" name="delete_url" class="inText" id="inText1"
                    placeholder="削除したい短縮URLのキーワードのみ（https://btln.ga/ 以降）を入力して下さい" onblur="coloeSet(this)"
                    onfocus="colorReset(this)" required="">
                <br><br>
                <input type="text" name="key" class="inText" id="inText2" placeholder="短縮URLの削除用キーを入力して下さい"
