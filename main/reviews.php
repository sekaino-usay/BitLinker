...
<body>
  ...
  <div class="flex">
    ...
    <div class="flex_txt">
      ...
      <blockquote>
        <p>クリック一回で短縮URLを作成でき，便利です！</p>
        <p>また，他のサービスでは短縮できない1000文字を超えるようなURLも短縮できるので利便性が高く，何度も利用させて頂いています．（ActiveTK. さん）</p>
      </blockquote>

      <blockquote>
        <p>日本人の学生が作成・運営している，純国産サービスなので，安心して利用できています！</p>
        <p>また，最近新しくなったサイトデザインもカッコ良くて気に入っています！（Knu さん）</p>
      </blockquote>

      <blockquote>
        <p>Androidのホーム画面にショートカットURLを置いて，アプリのように使ってます．たいへん便利♪（desertsowl さん）</p>
      </blockquote>
  ...
  <div class="flex">
    <div class="flex_txt">
      ...
      <br>
      <p>BitLinkerサイトデザインの変更に伴い，「利用者様の声」ページを新たに作成しました．</p>
      <p>そこで，実際に使用して頂いている方からコメントを募集しております．</p>
      <p>以下のフォーム（Googleフォームに飛びます）へ是非，コメントをお寄せ下さい！</p>
      <p>ご協力，よろしくお願いします！</p>
