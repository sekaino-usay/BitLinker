...
<body>
  ...
  <div class="flex">
    <div class="flex_txt">
      <h1>免責事項</h1>
      <br>
      <p>開発途中であるため，予告なくサービスの終了・短縮URLの利用停止を行う可能性があります．ご了承ください．</p>
      <p>また，システムの脆弱性等が発見される可能性もあります．早期発見・早期修正をするよう心がけますが，万が一脆弱性等を発見した場合は，<a href="./bug_report">バグ・脆弱性報告フォーム</a>へお知らせください．</p>
      <p>本サービスを利用する上で生じた障害・損失について，一切責任を負いません．</p>
    </div>
    <div class="flex_img">
