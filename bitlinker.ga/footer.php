...
<body>
  ...
  <br>
  <h2>サービス内容</h2>
  <p>完全無料＆登録不要で btln.ga/ から始まるカスタム短縮URLを作成することができます。SSL（https://~）対応＆全データ日本国内にあるサーバーで厳重に保管されているため、安心してお使いいただけます！</p>
  <br><br>
  <hr class="line" />
  <br>
  <h2>使い方</h2>
  <p>短縮前のURL、<i>btln.ga/</i> に続くカスタムワードを入力し、「短縮する！」ボタンを押してください。
    <br>
  ...
  <br>
  <h2>発見済バグ・脆弱性</h2>
  <p>発見済のバグ・脆弱性一覧は<a href="./bug.php">こちら</a>。解決策等教えていただけるとありがたいです。</p>
  <br><br>
