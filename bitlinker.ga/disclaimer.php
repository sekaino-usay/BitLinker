...
<head>
  <meta charset="utf-8">
  <title>BitLinker - 登録不要・純国産のカスタム短縮URL作成サービス｜Disclaimer</title>
  ...
  <div class="flex">
    <div class="flex_txt">
      ...
      <p>開発途中であるため、予告なくサービスの終了・短縮URLの利用停止を行う可能性があります。ご了承ください。
        <br>
        また、システムの脆弱性等が発見される可能性もあります。早期発見・早期修正をするよう心がけますが、万が一脆弱性等を発見した場合は、<a href="./bug_report.php">バグ・脆弱性報告フォーム</a>へお知らせください。
        <br>
